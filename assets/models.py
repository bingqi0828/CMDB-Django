...
class Asset(models.Model):
    ...
    sn=models.CharField(max_length=128, unique=True, verbose_name="serial name")
    status=models.SmallIntegerField(choices=asset_status, default=0, verbose_name="status code")
    manage_ip=models.GenericIPAddressField(null=True, blank=True, verbose_name="IP")
...
class Server(models.Model):
    ...
    created_by=models.CharField(choices=created_by_choice, max_length=32, default="auto", verbose_name="created time")
    ...
    raid_type=models.CharField(max_length=512, null=True, blank=True)
...
class SecurityDevice(models.Model):
    ...
    asset=models.OneToOneField('Asset', on_delete=models.CASCADE)
    sub_asset_type=models.SmallIntegerField(choices=sub_asset_type_choice, default=0, verbose_name="sercurity time")
...
#the following are the properties of the model
class IDC(models.Model):
    name=models.CharField(max_length=128, null=True, blank=True, verbose_name="IDC name")
    memo=models.CharField(max_length=128, null=True, blank=True, verbose_name="Some notes")
...
#the following are the inner properties
